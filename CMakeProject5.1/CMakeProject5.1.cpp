// CMakeProject5.1.cpp: определяет точку входа для приложения.
//Урок 32. Задача 1. Информация о фильме с кинопортала.
#include <string>
#include <fstream>
#include "nlohmann/json.hpp"
#include "CMakeProject5.1.h"
using namespace std;
